...
import { Phone, Mail, MapPin } from "lucide-react"; // install lucide-react for icons

const Contact = () => {
  return (
    <div className=" bg-gradient-to-b flex items-center justify-center p-8">
      <div className="w-full max-w-4xl bg-gray-200 shadow-lg rounded-2xl p-8 mt-6">
        {/* Header */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center space-y-6">
            <p className="text-gray-600">
              Got questions about your order, delivery, or menu? Reach us here:
            </p>
